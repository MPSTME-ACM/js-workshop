...
let taskInput = document.getElementById("taskInput"); //Input task
let addBtn = document.getElementById("addBtn"); //Button element
let taskList = document.getElementById("taskList"); //The place where list elements go
